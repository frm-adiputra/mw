...
// ServeHTTP calls the stored handler with the stored context, passing through the received
// HTTP Response and Request
func (a *ctxHandler) ServeHTTP(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	a.handler.ServeHTTP(ctx, w, r)
}
...
// ServeHTTP calls the stored handler with the stored context, passing through the received
// HTTP Response and Request
func (a *noopHandler) ServeHTTP(ctx context.Context, w http.ResponseWriter, r *http.Request) {}
